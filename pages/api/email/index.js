  ...
  if (total) {
    if (category) {
      mailOptions = {
        ...
        replyTo: email,
        subject: `Estimare noua de la ${name}`,
        html: `<p style="fonT-size:16px;">Nume: ${name}</p>
    <p style="fonT-size:16px;">Email: <a href="mailto:${email}"> ${email}</a></p>
    <p style="fonT-size:16px;">Telefon: <a href="tel:${phone}"> ${phone}</a></p>
    <p style="fonT-size:16px;">Mesaj: ${message}</p>
    <p style="fonT-size:16px;">Total: ${total}</p>
    <p style="fonT-size:16px;">Tip de aparat: ${machine_type}</p>
    <p style="fonT-size:16px;">Categorie: ${category}</p>
    `,
      };
    } else {
      mailOptions = {
        ...
        to: process.env.EMAIL_ADDRESS_REPLY,
        replyTo: email,
        subject: `Estimare noua de la from ${name}`,
        html: `<p style="fonT-size:16px;">Nume: ${name}</p>
    <p style="fonT-size:16px;">Email: <a href="mailto:${email}"> ${email}</a></p>
    <p style="fonT-size:16px;">Telefon: <a href="tel:${phone}"> ${phone}</a></p>
    <p style="fonT-size:16px;">Mesaj: ${message}</p>
    <p style="fonT-size:16px;">Total: ${total}</p>
    <p style="fonT-size:16px;">Tip de aparat: ${machine_type}</p>
    <p style="fonT-size:16px;">Servicii de mentenanță: ${maintenance}</p>
    <p style="fonT-size:16px;">Plobleme: ${problems}</p>
    <p style="fonT-size:16px;">Acord achiziție piese: ${parts_policy}</p>
    <p style="fonT-size:16px;">Utilizare (cafele pe zi): ${users}</p>
    `,
      };
    }
    ...
    cors(request, response, () => {
      transporter.sendMail(mailOptions, (error) => {
        if (error) {
          ...
          response.send("Mesaj trimis cu success!");
        }
      });
    });
    mailOptions = {
                            ...
                            <tr>
                              <td align="center">
                                <a href="http://www.google.com/" target="_blank">
                                  <img
                                    align="center"
                                    src="https://i.postimg.cc/2SCTfx6C/logo.png"
                                    alt="Art Cafe"
                                    width="600"
                                    height=""
                                    style="
                                          ...
                                          <tr>
                                            <td
                                              ...
                                              style="
                                                ...
                                                text-align: center;
                                              "
                                            > Îți mulțumim pentru cererea ta. 
                                              Analizăm   și vom reveni cu un răspuns în curând.
                                            </td>
                                          </tr>
                                        </table>
                                      </td>
                          ...
                          >
                            <tr>
                              <th
                                ...
                                "
                                background="https://i.postimg.cc/jjpfQzLp/Asset-3-2x.png"
                              >
                                <table
                                  align="center"
                                  width="100%"
